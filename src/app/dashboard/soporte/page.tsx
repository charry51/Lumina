        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 uppercase tracking-[0.2em] font-mono pl-1">
              Gestión de incidencias y consultas directas con el equipo LUMINADDDD
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {tickets && tickets.length > 0 ? (
          tickets.map((ticket: any) => (
            ...
            >
              <div className="cyber-card p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-[#00d2ff]/50 transition-all duration-300">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-3">
                    ...
                    <div className="flex items-center gap-1.5 text-[10px] text-zinc-500 font-mono uppercase">
                      <MessageSquare className="w-3 h-3 text-[#00d2ff]" />
                ...
                <div className="flex items-center gap-6">
                  ...
                  <ChevronRight className="w-5 h-5 text-zinc-700 group-hover:text-[#00d2ff] group-hover:translate-x-1 transition-all" />
                </div>
              </div>
            </Link>
          ))
