        ...
        await resend.emails.send({
          ...
          html: `
            <div style="font-family: sans-serif; padding: 20px; color: #333;">
              <h2 style="color: #7C3CFF;">Nuevo Ticket de Soporte (LuminAdd)</h2>
    ...
    if (esAdmin) {
      ...
      if (ticket?.perfiles?.email) {
        ...
        await resend.emails.send({
          ...
          html: `
            <div style="font-family: sans-serif; padding: 20px; color: #333;">
              <h2 style="color: #7C3CFF;">Nueva respuesta de LuminAdd</h2>
        ...
        if (adminEmail) {
          try {
            ...
            await resend.emails.send({
              ...
              html: `
                <div style="font-family: sans-serif; padding: 20px; color: #333;">
                   <h2 style="color: #7C3CFF;">El usuario ha respondido en LuminAdd</h2>
