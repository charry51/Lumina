  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 overflow-hidden px-4">
      ...
      <div className="mt-20 relative w-full max-w-5xl mx-auto animate-float">
          <div className="landing-glass-ui p-1 rounded-[2.2rem] shadow-[0_0_80px_rgba(124,60,255,0.15)] relative z-20">
             <div className="bg-black/95 rounded-[2rem] overflow-hidden border border-white/10 aspect-video md:aspect-[21/9] relative">
                {/* Simulated Dashboard UI */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#7C3CFF]/10 via-black to-black p-6 md:p-10 flex flex-col">
                    ...
                    <div className="grid grid-cols-12 gap-8 flex-grow">
                        ...
                        <div className="col-span-12 md:col-span-8 flex flex-col gap-6">
                            <div className="grid grid-cols-3 gap-6">
                                ...
                                <div className="landing-glass-ui border-white/5 p-5 flex flex-col justify-between group cursor-default">
                                    <p className="text-[9px] text-zinc-500 font-mono uppercase tracking-widest mb-1 group-hover:text-[#7C3CFF] transition-colors">Impressions</p>
                                ...
                                {/* Revenue Card (Gold) */}
                                <div className="landing-glass-ui border-white/5 p-5 flex flex-col justify-between group cursor-default">
                                    <p className="text-[9px] text-zinc-500 font-mono uppercase tracking-widest mb-1 group-hover:text-[#7C3CFF] transition-colors">Yield (24h)</p>
                                    <p className="text-2xl md:text-3xl font-heading text-white tracking-tighter text-gradient-ui">$12,408</p>
                                    <div className="mt-4 h-8 w-full">
                                        <svg viewBox="0 0 100 30" className="w-full h-full overflow-visible">
                                ...
                                {/* Active Nodes Card */}
                                <div className="landing-glass-ui border-white/5 p-5 flex flex-col justify-between group cursor-default">
                                    <p className="text-[9px] text-zinc-500 font-mono uppercase tracking-widest mb-1 group-hover:text-[#2BC8FF] transition-colors">Elastic Nodes</p>
                        ...
                        <div className="hidden md:flex col-span-4 flex-col gap-4">
                            <h4 className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest flex items-center gap-2">
                                <Play className="w-3 h-3 text-[#7C3CFF]" /> Live Logic Feed
                            </h4>
