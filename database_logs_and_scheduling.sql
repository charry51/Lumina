...
CREATE TABLE reproducciones_logs (
    ...
    pantalla_id TEXT REFERENCES pantallas(id) ON DELETE CASCADE,
...
ADD COLUMN hora_inicio TIME WITHOUT TIME ZONE DEFAULT '00:00:00',
ADD COLUMN hora_fin TIME WITHOUT TIME ZONE DEFAULT '23:59:59';
